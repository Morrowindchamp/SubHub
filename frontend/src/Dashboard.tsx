...
const subscriptionData: SubscriptionData[] = [
  { name: 'Netflix', value: 15.99, color: '#E50914' },
  { name: 'Spotify', value: 9.99, color: '#1DB954' },
  { name: 'Amazon Prime', value: 14.99, color: '#FF9900' },
  { name: 'Adobe CC', value: 52.99, color: '#FF0000' },
  { name: 'Others', value: 35.04, color: '#718096' },
];
...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <h1 className="text-3xl font-bold mb-6 text-gray-800">Unified Subscription Dashboard</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="col-span-2">
          <CardHeader>
            <CardTitle className="text-xl font-semibold">Subscription Breakdown</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-4xl font-bold text-green-600 mb-4">${totalAmount.toFixed(2)}</div>
            <p className="text-gray-600 mb-4">Next payment due: August 15, 2024</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
        <Card>
          ...
          <CardContent>
            <p className="text-gray-600 mb-4">Your subscriptions are protected for the next 60 days.</p>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-gray-600">Total saved this year through our unified service</p>
          </CardContent>
        </Card>
      </div>
    </div>
